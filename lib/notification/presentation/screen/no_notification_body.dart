  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          Center(child: Image.asset('assets/images/notification_icon.png',height: 100,width: 100,)),
          SizedBox(height: 10,),
          Text('ليس لديك اشعارات جديدة حتي الآن',style: TextStyle(color: kSecondaryColor,fontSize: 18),)
        ],
      ),
    );
  }
